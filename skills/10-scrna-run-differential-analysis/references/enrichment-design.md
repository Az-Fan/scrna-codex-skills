...
Write full database-specific tables plus a combined table, an enrichment dot plot, and a GSEA NES dot plot. Treat pathway adjusted P values as multiple-tested results. Use ORA input direction or GSEA NES for direction, and avoid treating overlapping pathway names as independent evidence.
