...
write_run_manifest(config, "analyze-scrna-subset", out, c(object_path, count_path, meta_path, summary_path, file.path(out, "features.tsv"), file.path(out, "barcodes.tsv")), "Parent object was not modified")
